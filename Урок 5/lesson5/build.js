...
var _MainPage = __webpack_require__(27);

var _MainPage2 = _interopRequireDefault(_MainPage);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var items = [['Главная', 'main'], ['Блог', 'blog'], ['Комментарии', 'comments'], ['Пользователи', 'users']];
var content = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid distinctio excepturi itaque laudantium numquam quos suscipit? Alias commodi corporis, dignissimos esse fugiat molestiae placeat tempora? At corporis error esse ipsam!';

_reactDom2.default.render(React.createElement(_MainPage2.default, { items: items, content: content }), document.getElementById('mainPage'));
...
var _MainContent = __webpack_require__(31);
...
var Item = function (_React$Component) {
    ...
    function Item() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Item.__proto__ || Object.getPrototypeOf(Item)).call.apply(_ref, [this].concat(args))), _this), _this.link = _this.props.item[1] + '.html', _temp), _possibleConstructorReturn(_this, _ret);
    }
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'a',
                    { className: 'menu__link', href: this.link },
                    this.props.item[0]
                )
            );
        }
